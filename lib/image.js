...
'cat.jpeg','microphone.jpeg', 'grass.jpeg', 'glasses.jpg', 'horse.jpeg', 'ball.jpeg'];
...
export const checkGuess = function(guess) {
  ...
  let hint = answerString[Math.floor(Math.random() * answerString.length)];
  if (guess.includes(answerString)) {
    ...
    $('#sub-message')
      .text(`Hint: there is a '${hint}' in the word.`)
      .fadeTo('slow', 1);
    fader = setTimeout(clearMessage, 1500);
  }
  return false;
};
